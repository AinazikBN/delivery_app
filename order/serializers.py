...
class OrderItemSerializer(serializers.ModelSerializer):
    product_title = serializers.ReadOnlyField(source='menu.title')
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        representstion = super().to_representation(instance)
        representstion['product'] = OrderItemSerializer(instance.items.all(), many=True).data
